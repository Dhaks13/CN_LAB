...
public class chat_client extends javax.swing.JFrame {	// JFrame to create a GUI.
   ...
   //GEN-BEGIN:initComponents
	...
	jButton2.setBounds(200,425,80,40);
    ...
    public void startRunning()
    {
       ...
       try
       {
            status.setText("Attempting Connection ...  client- Reg.No: 126015021");
            try
            {
            ...
            status.setText("Connected to: " + connection.getInetAddress().getHostName() + "  client- Reg.No: 126015021");

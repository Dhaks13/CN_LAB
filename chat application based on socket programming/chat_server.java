...
public class chat_server extends javax.swing.JFrame {	//JFrame to create a GUI.
    ...
    public void startRunning()
    {
        try
        {
            ...
            while(true)
            {
                try
                {
                    status.setText(" Waiting for Someone to Connect... Serevr Reg.No: 126015021");
                    connection=server.accept();		//establishes connection and waits for the client 
                    status.setText(" Now Connected to "+connection.getInetAddress().getHostName() + "Serevr Reg.No: 126015021");
   ...
   private void whileChatting() throws IOException
   {
	...
	jButton2.setBackground(new java.awt.Color(222, 22, 222));
	...
	jButton2.setBounds(200,410,80,40);


        status.setForeground(new java.awt.Color(255, 255, 255));
        status.setText("...");
        jPanel1.add(status);
        status.setBounds(10, 60, 500, 40);
